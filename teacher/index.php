      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
           ...
           $sql1 ="SELECT StudentId from tblstudents  WHERE ClassId = '$classid'";
...
?>
           ...
           $sql3="SELECT   result_id from  exam_test WHERE ClassId  = '$classid '";
...
?>
                ...
                <div class="card-body">
                  <div class="text-center">
                   ...
                   ?>
                    ...
                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" 
                       src="../admin/upload/<?php   echo $keys->photo ?>" alt="..."> 
                  </div>
  ...
  <script src="../admin/js/demo/chart-area-demo../admin/.js"></script>
