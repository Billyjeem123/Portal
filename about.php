...
foreach($row as $result):?>
        ...
        <ul class="navbar-nav m-auto">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item active" href="about.php">About our School</a>
  ...
  <main>
    <section class="py-5 container about-us">
      <h2 class="text-center py-3 ba">About Iqra Montessori School</h2>
<p class="about-us" >
